...
void main() {
    float radiusFactor = (1.0 + 0.2 * cos(position.y / 50.0 / PI * 2.0));
...
void main() {
    gl_FragColor = vec4( 
        transformedNormal, 
        transformedNormal.z > 0.0 ? pow(transformedNormal.z, 5.0) : 0.0);
}
`,
        });
        const geometry = new CylinderGeometry(20, 20, 2500, 32, 500, true);
